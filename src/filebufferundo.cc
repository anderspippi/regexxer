...
bool FileBufferActionInsert::do_undo(const SigC::Slot0<bool>&)
{
...
bool FileBufferActionErase::do_undo(const SigC::Slot0<bool>&)
{
  g_return_val_if_fail(!buffer().in_user_action(), false);
...
bool FileBufferActionRemoveMatch::do_undo(const SigC::Slot0<bool>&)
{
  if (match_)
  {
